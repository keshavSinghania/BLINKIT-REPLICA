            ...
            : <div className='home flex justify-center items-center' >
              ...
              {(userName === "Guest") ?
                ...
                <div className='flex items-center justify-center gap-1 w-[7vw] h-[6vh] text-lg text-gray-700'>
                  <p>Account</p>
                  {isDownArrow ? (<IoMdArrowDropdown size={25} className='cursor-pointer' onClick={() => { setIsDownArrow(!isDownArrow) }} />)
                    : (<IoMdArrowDropup size={25} className='cursor-pointer' onClick={() => { setIsDownArrow(!isDownArrow) }} />)}
                </div>
              }
              {/*account sectiondrop down box */}
              {
                isDownArrow ? 
                (<div className=' bg-white absolute top-[3vw] right-0 min-w-[13vw] min-h-[25vh] shadow rounded-lg flex items-center flex-col '>
                  {/* box content */}
